...
/**
 * This class has methods to work with records in an asynchronous way.
 */
public class FindoorProcessor {

    /**
     * This method computes records statistics from given list of records.
     */
    ...
    /**
     * This method computes location comparison between a target location with test location.
     */
    public static LocationComparison computeLocationComparisons(int locationToTestId,
                                                                List<RecordsStatistics> statisticsTarget,
                                                                List<RecordsStatistics> statisticsToTest) {
        List<RecordsComparison> comparisons = computeRecordsComparisons(statisticsTarget, statisticsToTest);
     ...
     * This method computes location comparison between a target location with test location.
     */
    public static List<RecordsComparison> computeRecordsComparisons(List<RecordsStatistics> statisticsTarget,
                                                                    List<RecordsStatistics> statisticsToTest) {
    ...
    /**
     * This method gets maximum signal level from a list of records statistics.
     */
    ...
    /**
     * This method gets a set with all BSSIDs from a list of records statistics.
     */
    ...
    /**
     * This method filters given list of records statistics depending of the amount of samples and
     * returns the result.
     */
